...
MediaPlayer.dependencies.StreamController = function() {
    ...
    var streams = [], activeStream, protectionController, ownProtectionController = false, protectionData, STREAM_END_THRESHOLD = .2, autoPlay = true, canPlay = false, isStreamSwitchingInProgress = false, isUpdating = false, hasMediaError = false, mediaSource, UTCTimingSources, useManifestDateHeaderTimeSource, attachEvents = function(stream) {
        ...
        if (!e.error) {
            var manifest = e.data.manifest, streamInfo = this.adapter.getStreamsInfo(manifest)[0], mediaInfo = this.adapter.getMediaInfoForType(manifest, streamInfo, "video") || this.adapter.getMediaInfoForType(manifest, streamInfo, "audio"), adaptation, useCalculatedLiveEdgeTime;
            if (mediaInfo) {
...
MediaPlayer.utils.TextTrackExtensions = function() {
    "use strict";
    var Cue, video, textTrackQueue = [], trackElementArr = [], currentTrackIdx = -1, actualVideoWidth = 0, actualVideoHeight = 0, captionContainer = null, videoSizeCheckInterval = null, isIE11 = false, fullscreenAttribute = null, displayCCOnTop = false, topZIndex = 2147483647, createTrackForUserAgent = function(i) {
...
window.portol = function() {
    ...
    PortolWSUtils.prototype.onwebsocketPlay = function(message) {
        this.triggerEndpointPlay(message);
        return this;
    };
    PortolWSUtils.prototype.onwebsocketPause = function(message) {
    ...
    function EndpointService(version, attrs, synchronizedStates) {
        ...
        this.god = {};
        this.eventBus = new EventBus([ "initRequest", "previewRequest", "websocketPlay", "websocketPause", "startPolling", "initReady", "previewReady", "videoReady", "paymentChange", "playerBuyRequest", "favoriteRequest", "bookmarkDeleteRequest" ]);
        this.mapEvents().grantRights();
        this.eventBus.subscribe(this, [ "initReady", "websocketPlay", "websocketPause" ]);
        return this;
    }
    ...
    EndpointService.prototype.grantRights = function() {
        ...
        this.loadBalService.triggerVideoReady = function() {
            self.triggerVideoReady();
        };
    ...
    function ControlBar(attrs) {
        ...
        this.drawerButton = new DrawerButton(attrs);
        ...
        this.buttons = [ this.drawerButton, this.watchButton, this.videoInfoButton, this.pairingButton, this.accountButton, this.portolButton ];
    ...
    ControlBar.prototype.grantRights = function() {
        this.drawerButton.triggerControlClick = this.eventBus.trigger.bind(this.eventBus, "controlClick");
    ...
    ControlBar.prototype.stateHandlerSetup = function() {
        var self = this;
        this.drawerButton.element.addEventListener("click", this.toggleDrawer.bind(this));
        return this;
    };
    ...
    ControlButton.prototype.clickAction = function() {
        this.togglePressed();
    ...
    SplashModule.prototype.buildScreenElement = function() {
        this.screenElement.style.backgroundImage = "url(" + this.playerState.metaData.splashURL + ")";
        return this;
    };
    SplashModule.prototype.onstartVideo = function() {
        this.screenElement.classList.add("dimming-gradient");
        return this;
    };
    ...
    FrameContainer.prototype.oninitReady = function() {
        ...
        document.onmousemove = function() {
            if (!document.getElementById("control-bar").classList.contains("hidden-drawer")) {
                ...
                this.dog = setTimeout(function() {
                    document.getElementById("control-bar").classList.add("hidden-drawer");
                    document.getElementById("portol-player").classList.add("hide-mouse");
                }, 3e3);
            } else {
                document.getElementById("control-bar").classList.remove("hidden-drawer");
                document.getElementById("portol-player").classList.remove("hide-mouse");
            }
        };
        return this;
    };
    ...
    FrameContainer.prototype.mapEvents = function() {
        ...
        this.eventBus.subscribe(this.panelsCarousel, [ "rotateCarousel" ]);
        return this;
    };
