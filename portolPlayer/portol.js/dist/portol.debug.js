...
window.portol = function() {
    ...
    if (!Object.prototype.watch) {
        Object.defineProperty(Object.prototype, "watch", {
            ...
            value: function(prop, handler) {
                var oldval = this[prop], getter = function() {
                    return oldval;
    ...
    function EndpointService(version, attrs, synchronizedStates) {
        ...
        this.god = {};
        this.eventBus = new EventBus([ "initRequest", "previewRequest", "websocketPlay", "websocketPause", "websocketStopped", "websocketOpen", "startPolling", "initReady", "previewReady", "videoReady", "paymentChange", "playerBuyRequest", "favoriteRequest", "bookmarkDeleteRequest", "freeviewTimeout", "loginAlert" ]);
        this.mapEvents().grantRights();
        this.eventBus.subscribe(this, [ "initReady", "websocketPlay", "websocketPause", "videoReady", "freeviewTimeout", "loginAlert" ]);
        return this;
    }
    ...
    EndpointService.prototype.grantRights = function() {
        var self = this;
        this.wsUtils.triggerWebsocketOpen = function(socket) {
            self.triggerEdgeWebsocketOpen(socket);
        };
    ...
    Player.prototype.processTimeUpdate = function(currentTime, totalTime) {
        ...
        if (!this.throttle) {
            ...
            this.throttle = true;
            var self = this;
            this.unthrottle = setTimeout(function() {
                self.throttle = false;
            }, self.THROTTLE_TIME);
        }
        return this;
    ...
    FrameContainer.prototype.grantRights = function() {
        ...
        this.playerContainer.triggerPreviewRequest = function() {
    ...
    function Portol(attrs) {
        ...
        this.god = {};
        this.eventBus = new EventBus([ "initRequest", "initReady", "previewRequest", "previewReady", "startPolling", "videoReady", "paymentChange", "login", "endpointPlay", "endpointPause", "playerBuyRequest", "favoriteRequest", "bookmarkDeleteRequest", "edgeWebsocketOpen" ]);
        this.mapEvents().grantRights();
        this.endpointService.doInit();
        return this;
    }
    Portol.prototype.mapEvents = function() {
        this.eventBus.subscribe(this.frameContainer, [ "initReady", "previewReady", "videoReady", "paymentChange", "endpointPlay", "endpointPause", "edgeWebsocketOpen" ]);
