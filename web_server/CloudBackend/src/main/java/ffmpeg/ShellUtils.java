...
public class ShellUtils {
	...
	public static boolean isRootPossible() {
		...
		try {
			...
			// Check for 'su' binary
			String[] cmd = { "which su" };
			int exitCode = ShellUtils.doShellCommand(null, cmd, new StdoutCallback(), false, true).exitValue();
	...
	public static int doShellCommand(String[] cmds, ShellCallback sc, boolean runAsRoot, boolean waitFor)
			throws Exception {
	...
	public static void logMessage(String msg) {
		System.out.println("FFMPEG runner msg: " + msg);
	}
