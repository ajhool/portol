package com.portol.loadbalancer.manager;
...
import com.portol.loadbalancer.config.MongoConfig;
...
public class MongoManaged implements Managed {
	...
	public MongoManaged(MongoConfig config) throws Exception {
		...
		MongoClientOptions o = new MongoClientOptions.Builder().socketFactory(getTrustAllCertsSocketFactory()).build();
